...
class WeatherSerializer(serializers.Serializer):
    ...
    isDay = serializers.ChoiceField(
        choices=["day", "night"], allow_null=True, required=False
    )
...
class ActivitySerializer(serializers.Serializer):
    activityLevel = serializers.ChoiceField(
        choices=["low", "medium", "high"], allow_null=True
    )
    speedLevel = serializers.ChoiceField(
        choices=["still", "walk", "run", "drive"], allow_null=True
    )
